...
/**
 ...
 of intermediate granularity.  Here we define the levels available for the NounPanel component.
 This level drives the level of all of the child components as well.
 */
const NounDictionaryItemPanelLevel = {
    'BASE': 100,
    'PLURALIZATION': 200
}

export {PluralizationRule}
export {NounDictionaryItemPanelLevel}
