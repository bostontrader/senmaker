...
describe('NouniAEStore', function() {
    ...
    it('ON_CLICK_ADD_NOUNI', function() {
        this.dispatch({type: NouniActionTypes.ON_CLICK_ADD_NOUNI})
    ...
    it('ON_CLICK_CANCEL', function() {
        ...
        this.dispatch({type: NouniActionTypes.ON_CLICK_CANCEL})
        expect(this.state).toBe(initialState)
    })
    ...
    it('ON_CLICK_SAVE_NOUNI, new nouni', function() {
        ...
        this.dispatch({type: NouniActionTypes.ON_CLICK_SAVE_NOUNI, nouni: {}})
        expect(this.state).toBe(initialState)
    })
    ...
    it('ON_CHANGE_SELECTED_NOUND', function() {
        ...
        expect(true)
        expect(this.state.getIn(['nouni','nound']).toJSON()).toEqual({id:'666', base: 'box', plural: 'boxes', pluralization_rule: PluralizationRule.Append_es})
    })
