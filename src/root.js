...
//NoundActions.insertNound({base: 'box'})
...
//AdjectivdActions.insertAdjectivd({base: 'short'})
//AdjectivdActions.insertAdjectivd({base: 'fat'})
//AdjectivdActions.insertAdjectivd({base: 'lazy'})
