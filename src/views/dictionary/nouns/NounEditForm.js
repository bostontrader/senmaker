...
function NounEditForm(props) {
    ...
    if(props.level.getIn(['currentAppLevelConfig','nounPanel']) >= NounDictionaryItemPanelLevel.PLURALIZATION) {
        nounEditForm =
            <div>
                <label htmlFor='base'>Base</label>
                <input id='base' name='base' type='text' value={props.addEditNoun.getIn(['noun','base'])} onChange={(e)=>props.onChangeNounBase(e.target.value)}/>
    ...
    } else if(props.level.getIn(['currentAppLevelConfig','nounPanel']) >= NounDictionaryItemPanelLevel.BASE) {
        nounEditForm =
            <div>
                <label htmlFor='base'>Base</label>
                <input id='base' name='base' type='text' value={props.addEditNoun.getIn(['noun','base'])} onChange={(e)=>props.onChangeNounBase(e.target.value)}/>
